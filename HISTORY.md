...
- For kisura I manually installed nfs manager https://www.bresink.com/osx/143439/download.php and allowed the \
app /Library/PrivilegedHelperTools/NFSManager-PrivilegedTool full disk access in `system preferences -> Security & privacy -> Privacy -> Full Disk Access`. This is one of the very few apps that I installed manually
- also I added iterm2 and terminal to the helper apps with full disk access
